...
Mock.mock('/api/bannerdata', (req, res) => {
  return {
    data: [
      {
        "id": "1",
        "img": "./static/img/swiper/swipe1.jpg"
      },
      {
        "id": "2",
        "img": "./static/img/swiper/swipe2.jpg"
      },
      {
        "id": "3",
        "img": "./static/img/swiper/swipe3.jpg"
      },
      {
        "id": "4",
        "img": "./static/img/swiper/swipe4.jpg"
      },
      {
        "id": "5",
        "img": "./static/img/swiper/swipe5.jpg"
      },
      {
        "id": "6",
        "img": "./static/img/swiper/swipe6.jpg"
      }
    ]
  }
})
